...
#include "Compat.h"
#ifdef _WIN32
#include "..\..\3rd_party\mysql\include\mysql.h"
#else
#include <mysql.h>
#endif
#include <cstdio>
...
#include <math.h>
#ifdef _WIN32
#include "..\..\3rd_party\pthread\include\pthread.h"
#else
#include <pthread.h>
#endif
//#include <vector>
...
class CBaseSocket
{
    public:
        ...
        void	CloseSocket( SOCKET sock );	// Close Socket     //will not allow a void type here so I'm passing a dummy socket
