...
unsigned int CMonster::GetAttackPower()
{
    ...
    if(thisnpc->weapon!=0)
    {
        ...
        attack += GServer->EquipList[8].itemList.at (thisnpc->weapon)->attackpower;
    }
...
unsigned int CMonster::GetDefense()
{
    ...
    {
        defense += GServer->EquipList[SUBWEAPON].itemList.at (thisnpc->subweapon)->defense;
    }
...
unsigned long long CMonster::GetMaxHP( )
{
    ...
    ///PY. OMFG! This is a whole new level of STUPID. shp comes from column 42 in the STB. It's the NPC Model Z offset used in the graphics engine
	// Let's all go around setting our maximum HP to the Z offset value. Sounds like a great idea. *face palm*
	/*if(MaxHP == 0)
    {
...
bool CMonster::ForceMaxHP( )
{
    ...
    ///NO... Just NO! We most definitely DO NOT set maxHP to the value of the graphics Z Offset
	/*if(MaxHP==0)
    {
        MaxHP = (unsigned long long) thisnpc->shp;
    }*/
