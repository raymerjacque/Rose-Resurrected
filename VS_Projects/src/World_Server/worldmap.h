...
class CMap
{
    ...
    bool DeleteMonster( CMonster*, bool clearobject=true, UINT i=0 );
	...
	CNPC* GetNPCInMapByType (UINT npcType);			//PY returns the npc based on the list_npc.stb reference row (montype)
